...
describe('query-selector', () => {
    ...
    before(() => {
        queries = '' +
            '{"defaultQuery":' +
            '[{"displayName":"name","query":"findByName","filters":[{"name":"name","type":"String", "collection": false}]},' +
            ...
            '{"displayName":"persistenceId","query":"findByPersistenceId","filters":[{"name":"persistenceId","type":"Int", "collection": false}]}],' +
            '"additionalQuery":' +
            ...
            '{"displayName":"findByAddressAndPhoneNumberAndName","query":"findByAddressAndPhoneNumberAndName","filters":[{"name":"address","type":"String"},{"name":"phoneNumber","type":"String", "collection": false},{"name":"name","type":"String", "collection": false}]},' +
    ...
    it('Should component behave correctly when queries attribute is not provided', async () => {
        querySel = await fixture(html`<query-selector queries='{}'></query-selector>`);
    ...
    it('Should component behave correctly when queries attribute is empty', async () => {
    ...
    it('Should display the init parameters when the init attribute is used', async () => {
        init = '{"query": ' +
            ...
            '"filters":[{"name":"name","type":"String","collection":false,"value":"myName"},{"name":"phoneNumber","type":"String","collection":false,"value":"myPhoneNumber"}],' +
            '"pagination": {"p":2,"c":20}}'
